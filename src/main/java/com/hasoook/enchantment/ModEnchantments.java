...
public class ModEnchantments {
    ...
    public static Enchantment Blunt = register("blunt", //磨钝
            new Blunt(Enchantment.Rarity.RARE, EnchantmentTarget.WEAPON, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    public static Enchantment Looted = register("looted", //被抢
            new Looted(Enchantment.Rarity.RARE, EnchantmentTarget.WEAPON, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    public static Enchantment SoulEntanglement = register("soul_entanglement", //灵魂纠缠
            new SoulEntanglement(Enchantment.Rarity.VERY_RARE, EnchantmentTarget.ARMOR_FEET, new EquipmentSlot[]{EquipmentSlot.FEET}));
    public static Enchantment Hematology = register("hematology", //血包
            new Hematology(Enchantment.Rarity.RARE, EnchantmentTarget.ARMOR, EquipmentSlot.values()));
    ...
    public static Enchantment FrostThorns = register("frost_thorns", //冰霜荆棘
            new FrostThorns(Enchantment.Rarity.VERY_RARE, EnchantmentTarget.ARMOR, new EquipmentSlot[]{EquipmentSlot.CHEST}));
