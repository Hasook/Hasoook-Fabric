...
public class CattivaEntity extends TameableEntity implements GeoEntity {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(3, new FleeEntityGoal<>(this, PlayerEntity.class, 8.0f, 1.0, 1.0, EntityPredicates.EXCEPT_CREATIVE_OR_SPECTATOR::test)); //逃离玩家
        ...
        this.goalSelector.add(5, new AttackGoal(this));  // 攻击目标
        this.goalSelector.add(7, new WanderAroundFarGoal(this, 0.75f, 1)); //游荡
